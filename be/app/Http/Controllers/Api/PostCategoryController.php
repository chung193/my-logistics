...
class PostCategoryController extends Controller
{
    ...
    {
        $pages = PostCategory::with('translations')->paginate(20);
    ...
    public function show(PostCategory $page)
    {
        $page->load('translations');
        return response()->json($page);
    }

    public function update(Request $request, PostCategory $page)
    {
        $data = $request->validate([
    ...
    public function destroy(PostCategory $page)
    {
        $page->delete();
