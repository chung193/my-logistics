...
export default async function AboutPage({ params }: { params: { locale: Locale } }) {
    ...
    return (
        <>
            {/* breadcrumb start */}
            <PageBreadcrumb pageName={t.pages.customs_brokerage.title} />
            {/* breadcrumb end */}
                            ...
                            <div className="col-lg-6 align-self-center">
                                <div className="about-inner-wrap">
                                    <div className="section-title mb-0">
                                        <h3 style={{ color: "#2c4397" }}>{t.pages.customs_brokerage.subtitle}</h3>
                                        <p className="content left-line small-font">
                                            {t.pages.customs_brokerage.summary}
                                        </p>
                                        <p className="content small-font" style={{ whiteSpace: 'pre-line' }}>
                                            {t.pages.customs_brokerage.content}
                                        </p>
